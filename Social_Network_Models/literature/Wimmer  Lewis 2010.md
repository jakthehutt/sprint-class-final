AJS Volume 116 Number 2 (September 2010): 583–642
583
 2010 by The University of Chicago. All rights reserved.
0002-9602/2010/11602-0006$10.00
Beyond and Below Racial Homophily:
ERG Models of a Friendship Network
Documented on Facebook1
Andreas Wimmer
University of California, Los Angeles
Kevin Lewis
Harvard University
A notable feature of U.S. social networks is their high degree of
...
cebook pages of a cohort of college students. They ﬁrst show that
...
or those from particular states) all inﬂuence the tie formation process
more than does racial homophily.
INTRODUCTION
Homophily—the principle that “birds of a feather ﬂock together”—has
...
Processus Sociaux of the University of Neuchaˆtel, Switzerland. The authors thank
...
584
(for a review, see McPherson, Smith-Lovin, and Cook [2001]). In partic-
...
ﬁeld and Sagar 1977; Patchen 1982; Epstein 1985; Hallinan and Smith
...
arship, however, ﬁnds a large degree of racial homophily even after taking
...
sistance, and Brian Min for producing ﬁg. 3. Peter Marsden, Nicholas Christakis,
...
Bob Hanneman and Mark Newman were equally supportive in helping us to ﬁnd the
most appropriate way to cluster student tastes, and Carter Butts advised us on alter-
native permutation-based methods to conﬁrm our ﬁndings. We are indebted to out-
...
Beyond and Below Racial Homophily
585
tion—might be produced by micromechanisms other than the psycholog-
...
ground in the ﬁrst place. More recent empirical research suggests that the
effects of racial homophily are also ampliﬁed by balancing mechanisms,
...
size. In order to disentangle these different causal pathways, we ﬁrst
...
nisms, and show how these mechanisms conjointly produce a speciﬁc
...
zation of ethnoracial classiﬁcation systems that considers a number of
...
American Journal of Sociology
586
relationship, while acknowledging that they might qualitatively differ
...
Kao and Joyner 2004).
Second, racial homophily proper is “ampliﬁed” by balancing mecha-
...
racial homophily if there is signiﬁcant overlap in category membership.
...
Beyond and Below Racial Homophily
587
uates of elite high schools, who largely tend to be white, rather than due
...
without homophily proper. However, we ﬁnd that such “intersection ef-
...
background—for generating the overall structure of this network. We ﬁnd
...
The article is structured as follows. We ﬁrst offer a theoretical framework
for understanding how different sociodemographic structures inﬂuence var-
...
American Journal of Sociology
588
micromechanisms of tie formation beyond racial homophily to account for
...
works, we demonstrate the crucial contribution of ampliﬁcation effects
...
tie formation mechanisms inﬂuence the racial composition of networks.
Our ﬁrst task is thus to develop a theoretical framework that allows us
to consider how different tie-generating mechanisms inﬂuence overall net-
...
are in turn inﬂuenced by four sociodemographic structures: the distri-
...
categories. These four structures produce speciﬁc effects on the tie-gen-
...
Fig. 1.—Social structures, tie formation mechanisms, and network composition. Indirect effects are represented with dashed lines.
...
sociodemographic structures, for example, by inﬂuencing resource distri-
bution through social closure mechanisms (on macro-micro-macro types
of explanations, see Coleman [1990], Bunge [1997], and Hedstro¨m [2005]).
...
ﬁrst on the pool of potential friendship partners and on the distribution
...
are sitting face to face at their two desks in a windowless ofﬁce every
...
Beyond and Below Racial Homophily
591
in Goodreau et al. [2009], “in-group preference” in Blau [1977], and “choice
...
tiﬁed in our theoretical framework. Several endogenous networking mech-
anisms can be identiﬁed.2 First, two individuals might become friends
...
American Journal of Sociology
592
summary in Hallinan [1978–79], p. 195). To put it differently, balancing
...
how balancing mechanisms inﬂuence the observed degree of network
homogeneity through an “ampliﬁcation effect” of sorts: if there is a genuine
...
indirectly inﬂuenced by the unequal distribution of networking disposi-
...
reciprocating ties. Group-speciﬁc networking dispositions, in other words,
may either increase or reduce the level of homogeneity of networks, and
they thus produce potentially important modiﬁcation effects.
Finally, we can identify two additional types of indirect effects through
which sociodemographic structures inﬂuence the tie formation process and
...
Beyond and Below Racial Homophily
593
Besides this “category intersection” effect, we also have to take processes
...
social category may ﬁnd themselves (whether through self-selection or
...
into certain population pools or speciﬁc spatial or institutional foci. Se-
lection and sorting processes therefore inﬂuence overall network com-
...
into account.4
Having distinguished between four sociodemographic structures andhow
they inﬂuence the four tie formation mechanisms through a variety of direct
...
entangling group size effects from all other processes that inﬂuence overall
network composition has now become so widespread that researchers have
4 Kossinets and Watts ﬁnd, in their study of e-mail exchanges among members of a
...
American Journal of Sociology
594
almost exclusively focused on the racial composition of networks net of
...
who are classiﬁed into the same racial group might form a tie because
...
geneity is also inﬂuenced—in addition to homophily—by the mixing op-
portunities between members of different racial categories (Marsden 1988;
Moody 2001; Berry 2006). The expectation that availability inﬂuences
...
and Entwisle (2006) are the ﬁrst to demonstrate how spatial proximity in
the neighborhood where students live might inﬂuence the formation of
...
(deﬁned as receiving a high number of identical mass e-mails) are taken
...
these shared foci are signiﬁcantly correlated with racial categories due to
...
same-race friendship may end up “counting twice” if the ﬁrst tie (A to B)
...
American Journal of Sociology
596
are formed because they are in-group ties will be overestimated if bal-
...
of same-race preference that inﬂuenced the formation of the ﬁrst tie.
...
major breakthrough. It was the ﬁrst to disentangle homophily from triadic
...
Meanwhile, new speciﬁcations for exponential random graph models are
speciﬁcally designed to incorporate such “endogenous” balancing mech-
...
grants disidentify, at least in the ﬁrst generation, with overarching racial
...
Beyond and Below Racial Homophily
597
category in order to distance themselves from the Japanese community
...
92% of Korean origin, and 65% of Indian origin identiﬁed with a country-of-origin
category, and only 6%, 2%, and 9%, respectively, identiﬁed with higher-level categories
...
American Journal of Sociology
598
Japanese) tie formation. In other words, racial similarity is the sole driving
...
that identiﬁes individuals not only on the basis of membership in the
...
Unfortunately, the information on students’ backgrounds that one ﬁnds
...
difﬁcult to disentangle homophily effects from the effects of opportunity
structures, deﬁned by the composition of the school population along these
attribute criteria,8 and from the consequences of the “attribute intersec-
8 Mouw and Entwisle (2006) are the ﬁrst to our knowledge to have addressed this issue
...
Beyond and Below Racial Homophily
599
tionality” between racial and these other social categories. On the other
...
force many researchers to rely on racial classiﬁcation, gender, and age
...
disposition to form ties in the ﬁrst place, to reciprocate a friendship, or
...
to the same degree. In order to control for the modiﬁcation effect of
...
guish racial homophily from other tie-generating mechanisms that inﬂu-
...
character of ethnoracial systems of classiﬁcation and the consequences
...
Our research is the ﬁrst to integrate these various lines of argument into
...
American Journal of Sociology
600
group size effects, shared foci effects, balancing and sociality mechanisms,
...
promises to address some of the difﬁculties and obstacles discussed above
...
proﬁle pages of an entire college cohort of 1,640 students. Network data
...
anisms into account. We ﬁrst discuss the general properties of this data
set, then describe the particular type of network data that we utilize in
the following analyses, and ﬁnally introduce the individual attribute data,
giving special attention to the ethnoracial classiﬁcation scheme developed
for this study.
Project History
Launched in February 2004, Facebook allows users to create detailed
personal proﬁles viewable by default to anyone in a given network. In-
dividuals can enter information on their background (e.g., high school,
hometown), demographics (e.g., birthday, gender), “interests,” afﬁliations
with online as well as ofﬂine clubs and associations, and cultural tastes
...
Gross and Acquisti 2005; Ellison, Steinﬁeld, and Lampe 2007; Golder,
...
Beyond and Below Racial Homophily
601
through Facebook; it modeled friendship formation among students at
Texas A&M (Mayer and Puller 2008).
With permission from Facebook and the university in question, we
downloaded the proﬁle and network data provided by one cohort of col-
...
maintained Facebook proﬁles at the time of the download (compared to
45% at Texas A&M), and over half had last updated their proﬁle within
ﬁve days.9 The college also agreed to provide additional data on these
students, such that we were able to link each Facebook proﬁle with an
ofﬁcial student housing record.10
...
college cohort provides a socially meaningful boundary that is justiﬁable
...
and ethnic background (see ﬁg. 2, below). The college now also observes
...
9 While users have the option to make their proﬁles “private” and thus viewable only
by listed friends, the majority (88.2%) of students in our population maintained “public”
proﬁles at the time of our download. The remaining students were either not registered
on Facebook (2.6%) or were registered on Facebook but maintained private proﬁles
...
(2007).
10 Student privacy was assured by converting all names to numerical identiﬁers and
...
American Journal of Sociology
602
in U.S. racial politics are well represented within the student body and
among the faculty.
Picture Friends
...
How did we deﬁne a “picture friendship”? Registered users can upload
albums to their proﬁles ﬁlled with photographs viewable by others. Ad-
...
ﬁnding is supported by other research indicating that Facebook is used primarily to
maintain or reinforce existing ofﬂine relationships rather than to meet new people
(Ellison et al. 2007).
...
Beyond and Below Racial Homophily
603
that the series of actions that lead to a picture friendship requires more
...
speciﬁc types of relationships they document on their Facebook pages by
...
“friendship.”
While we are therefore conﬁdent that pictures on Facebook represent
...
inated as “best friend” also list ego as one of their ﬁve friends (Vaquera and Kao 2008,
p. 64). The level of reciprocity there is expected to be higher than among picture friends
given that one of the ties in the dyad is by deﬁnition a strong tie (“best friend”).
...
American Journal of Sociology
604
are documented in this way, and we cannot exclude a systematic selection
...
used to deﬁne a Facebook friendship. An online appendix to this article
...
of our 1,640 students actually do post
(N p 736)
pictures online.14 For the main analyses of this article, we take the prag-
matic approach of redeﬁning our network boundary to include only these
...
women are more likely to post pictures than men
students of
(P ! .001),
a mixed racial background more likely than members of other racial
categories
, Americans more likely than foreigners
, stu-
(P ! .05)
(P ! .05)
dents from South Atlantic and Paciﬁc states more likely than students
from other regions
, and students from New England less likely
(P ! .05)
...
of the 90,000 adolescents who completed the questionnaire identiﬁed with a racial or
...
possible approach is to “deﬁne away” these missing data by considering those students
...
Beyond and Below Racial Homophily
605
these two populations is statistically indistinguishable.16 We are now in a
position to describe how these and other attributes were measured and
also to introduce the ethnoracial classiﬁcation scheme developed for this
study.
Individual Attributes I
Gender was coded based on self-report and on student photographs and
ﬁrst names in the case of missing data. Fifty-nine percent of picture posters
are female, and 41% are male. Socioeconomic status (SES) was much
more difﬁcult to code because students do not report anything approxi-
mating socioeconomic data in their proﬁles. Rather than omit this im-
...
tiﬁed in Cookson and Persell (1985, p. 43; see also Baltzell 1958). These
...
town” on their proﬁles, typically listed in the form of “city, state, ZIP
...
ﬁrst, a simple “foreign/American” dichotomy; second, “Americans” were
...
states, and 16% from the Paciﬁc region; 8% were international students.
Twelve percent of the students could not be identiﬁed in terms of their
regional origin.18
...
proﬁles more recently, and they appear in the photo albums of other students more
often.
...
American Journal of Sociology
606
Gender, SES, and regional origin are here considered exogenous predic-
tors of friendship, since a person’s gender, socioeconomic background, and
regional origin are not inﬂuenced by the ties she forms in college. We also
...
diversity). We ﬁnd no signiﬁcant correlation between racial similarity and
...
niﬁcant decrease in the likelihood of being assigned to the same room
It therefore seems likely that “diversity” in terms of racial back-
(P ! .01).
...
students, for whom the ﬁve largest majors were economics (15%), political
...
Beyond and Below Racial Homophily
607
boundaries (Erickson 1996) and even as causal determinants of network
structures (Lizardo 2006; Steglich, Snijders, and West 2006; Lewis and
Kaufman 2010). Facebook proﬁles contain open-ended spaces for re-
...
19 Speciﬁcally, beginning with three N # M incidence matrices (one each for movies,
...
method, we also replicated our ﬁnal model (model 6) by omitting all terms associated
with taste clusters and instead including these original dyadic measures of taste sim-
ilarity. This change had very little effect on the direction and signiﬁcance of other
effects in the model and in fact produced a worse overall ﬁt (i.e., higher AIC; results
not shown).
20 Both academic majors and cultural tastes are attributes where selection and peer
inﬂuence effects cannot be disentangled clearly without a longitudinal design. Two
...
and their relative importance vis-a`-vis racial homophily in this network. We should
...
housing groupmates share signiﬁcantly more tastes in movies and in music than we
...
present), students display a signiﬁcant preference for culturally similar alters—sug-
...
American Journal of Sociology
608
ular authors were J. K. Rowling (23%), F. Scott Fitzgerald (13%), and
...
[2008]). First, we deﬁne race and ethnicity as social categories conceived
and deﬁned by actors themselves based on their belief that members of
...
dynamic, that is, through the interplay between self-identiﬁcation and clas-
siﬁcation by others. The degree to which both overlap varies. In some cases,
self-identiﬁcation and classiﬁcation by others neatly coincide; in otherscases,
...
self-identiﬁcation and categorizations by others therefore need to be taken
...
be perceived and classiﬁed by others) on the basis of proﬁle photos, photos
...
who adhere to this encompassing deﬁnition of ethnicity includes Gordon (1964), Wall-
...
panic” and “Asian” racial categories have been adopted as categories of self-identiﬁ-
...
dicate on their proﬁles that they are members of one or more of the many
...
resents an accurate proxy for the ethnic categories a student identiﬁes
...
conﬁdent that we capture most of students’ identities that are publicly
acknowledged and thus socially relevant.25 We are conﬁdent that the mea-
surement error of our research instrument is lower as compared to those
of standard tools such as surveys with a ﬁxed number of racial identity
boxes to tick.26
24 Visual coding using a single online photograph and rudimentary classiﬁcation scheme
is itself not unprecedented (Berry 2006; Mayer and Puller 2008). Studies based on the
General Social Survey (GSS) report that self-identiﬁed and surveyor-identiﬁed “race”
...
nicity coders on a trial 100 proﬁles was 95%—the ﬁve discrepancies resulted from an
ambiguity in our coding procedure, which has since been corrected.
25 We only included clubs and groups that suggest identiﬁcation with a particular ethnic
category, as opposed to support or interest in a region or particular cultural practice.
For example, we excluded groups that were preoccupied with conﬂicts and under-
...
reinforcing relationship between subjective identiﬁcation with a category and friendship
with other members of that category, we expect that cases where identiﬁcation entirely
...
extracurricular activities inﬂuence the likelihood of interracial friendship in high schools
...
American Journal of Sociology
610
The most encompassing categories we employed are four racial cate-
...
least sense in terms of self-identiﬁcation, we use a more ﬁne-grained dis-
...
who identiﬁes with her Irish heritage is thus treated in the same way as
a ﬁrst-generation Irish immigrant—in line with the subjectivist principle
alluded to above.27 This procedure produced the classiﬁcatory scheme
shown in ﬁgure 2.28
...
28 Three clariﬁcations are in order. First, not all categories in the taxonomic tree are
...
procedure but is inductively gained from the categories that students themselves ﬁnd
...
mode of identiﬁcation.


--- PAGE BREAK ---

Fig. 2.—A multilevel, nested scheme of ethnoracial classiﬁcation. Dark grey boxes contain racial categories, light grey boxes ethnic categories, and
white boxes “microethnic ” (or country/countries-of-origin) terms. Numbers immediately following category names refer to the quantity of individuals
in that category who posted pictures
; those in parentheses refer to the composition of the entire population
Seventeen students
(N p 736)
(N p 1,640).
whose race/ethnicity could not be determined and one self-identiﬁed Native American are omitted from this diagram.
...
American Journal of Sociology
612
reciprocity simultaneously into consideration. Since few readers will be
...
with various speciﬁcations of a model and then select the speciﬁcation
...
variable Yij is speciﬁed as yij, and Y is the matrix of all such variables
...
other variables.
Second, the analyst proposes a dependence hypothesis deﬁning the ways
in which the observed ties may be related. This hypothesis implies a
particular form to the model—speciﬁcally, the model represents a distri-
bution of random graphs that are the “global” outcome of a number of
“local” patterns, or conﬁgurations. The summation in the model is taken
over all conﬁgurations A; these conﬁgurations represent the types of de-
pendencies that the analyst expects to ﬁnd in the network, such as mutual
...
sponding to conﬁguration A, equal to one if the conﬁguration is observed
...
Beyond and Below Racial Homophily
613
and zero otherwise. Each network statistic is then associated with a pa-
rameter, hA. This parameter indicates the importance of conﬁguration A
...
A
If
is the amount by which the g-statistics change when Yij is
dg (y)
A
...
through its formation, “close” exactly one triangle. Each model coefﬁcient
thus indicates whether the observed network contains more (positive co-
efﬁcient) or fewer (negative coefﬁcient) of conﬁguration A than we would
expect by chance alone—controlling for all other conﬁgurations in the
model.
...
of increasingly realistic assumptions about the nature of these conﬁgu-
...
ﬁrst to avoid the assumption of dyadic independence. Markov dependence
...
values generated by pseudo-likelihood, but it then repeatedly reﬁnes these
...
American Journal of Sociology
614
values by comparing simulated distributions of graphs against the ob-
served data.
...
poorly speciﬁed (Handcock 2003a, 2003b). It is particularly common
among networks with high concentrations of triangles, where the Markov
speciﬁcation intended to capture the process of triadic closure—namely,
a basic triangle conﬁguration—often proved untenable (see Robins et al.
2007b).
In this article, we employ a series of new network speciﬁcations pro-
...
include these speciﬁcations also show an improved ﬁt over previous mod-
...
these various conﬁgurations into a single, more empirically plausible term.
Similarly, new statistics for star conﬁgurations (the “geometrically
...
predecessors. This article is one of the ﬁrst to use these modeling techniques
...
man, and Pescosolido [2008], and Goodreau [2009]). Ours also is the ﬁrst
...
Beyond and Below Racial Homophily
615
(Robins, Pattison, and Wang [2009] use two smaller networks with less than
...
a problem for many empirical networks, and even a demonstrated ﬁt
...
In a ﬁrst step, we calculated coefﬁcients for a model of tie formation that
...
the coefﬁcients for racial homophily may be interpreted as representing
...
consistently high and signiﬁcant degree of homophily/homogeneity along
...
30 All ERG models and goodness-of-ﬁt plots in this article were generated using ergm,
...
from Paciﬁc states ( white,  Asian and mixed); (4) Californians ( white,  Asian). Hom-
...
American Journal of Sociology
618
In model 2 we introduce terms for lower levels of ethnic and microethnic
...
efﬁcients for whites, blacks, and Asians are all reduced when lower-level
ethnic homophily terms are included. Speciﬁcally, the white coefﬁcient
decreases by over 20%, the black coefﬁcient decreases by 7%, and the
Asian coefﬁcient decreases by 50%. The coefﬁcient for mixed students
...
actually have a slight (but insigniﬁcant) aversion toward each other after
...
East Asians, while the coefﬁcients for all other same-race, different-eth-
nicity pairs are either negative or positive but not signiﬁcant (results not
shown). Meanwhile, in the case of black homophily, the aggregation effect
is weakest, and we ﬁnd consistently high and signiﬁcant rates of other-
...
observed tendency for same-race friendships is ampliﬁed by the balancing
...
mechanisms, all racial homophily coefﬁcients decrease by at least 28%
...
coefﬁcients, we see that (net of other factors) a friendship that symmetrizes
...
three born abroad. Including homophily terms speciﬁcally for foreign-born ethnic cat-
...
Beyond and Below Racial Homophily
619
occur than a friendship between two students who share membership in
...
reduced to race-speciﬁc reciprocity and triadic closure, thus rejecting this
alternative interpretation.33
32 More speciﬁcally, the edge coefﬁcient of 5.96 in model 3 refers to the log-odds of
...
Interpretation of the GWESP coefﬁcient is more complex, but a positive coefﬁcient
...
coefﬁcients, see Snijders et al. (2006), Hunter (2007), and Robins et al. (2007b).
...
action effects for each racial category. In practice, this entailed adding to model 3 ﬁve
race-speciﬁc reciprocity effects: one for white-white dyads, one for Asian-Asian dyads,
...
respect to reciprocity (as hypothesized by Vaquera and Kao [2008], who ﬁnd that Asians
have a higher and black adolescents have a lower tendency to reciprocate ties compared
to whites). In this model, the coefﬁcients for all homophily-dependent reciprocity terms
...
American Journal of Sociology
620
While ERG models with homophily terms automatically take different
...
differential networking behavior may inﬂuence the extent of racial ho-
...
reference category—race-speciﬁc balancing terms are unfortunately not
yet available in statnet.34 All racial groups except blacks have signiﬁcantly
larger networks of picture friends than do whites (as evidenced by positive
and signiﬁcant sociality coefﬁcients). As expected, controlling for these
differences modiﬁes the homophily coefﬁcients, as a comparison of models
1 and 4 reveals: the homophily coefﬁcient of groups with small networks
increases, while the coefﬁcients of those with relatively large networks
decreases. In particular, we see that the homophily coefﬁcient for students
with a “mixed” racial background was inﬂated (to the point of statistical
signiﬁcance) by these students’ unusually high tendency to form ties in
...
trend into account. Unfortunately, due to the lack of availability of race-speciﬁc
...
yses using pseudo-likelihood estimation and race-speciﬁc triangle terms again support
our interpretation that the general rate of triadic closure is not dependent on the
tendency for race-speciﬁc triadic closure. The same conclusion is reached in a GSS-
...
34 Pnet, meanwhile, can run models with race-speciﬁc reciprocity terms. Consistent
with Vaquera and Kao (2008), we ﬁnd that Asian students reciprocate friendships more
...
magnitude of the race-speciﬁc reciprocity terms, as expected (results not shown).
...
Beyond and Below Racial Homophily
621
homogenous networks. We do this by adding terms for all of those social
categories and shared foci with which at least one racial category is sig-
niﬁcantly correlated. This produces a list of 23 terms included in model 5
...
ally the case: the coefﬁcients of most racial homophily terms (with the
...
of these terms indeed have positive and signiﬁcant coefﬁcients—they affect
...
tively more ties with all available others. To put these ﬁndings into ev-
...
may indeed ﬁnd their shared racial background, and thus their shared
...
of the ﬁrst, and/or reciprocating a friendship that the ﬁrst has extended.
It seems that they are not greatly inﬂuenced, however, by the fact that
their racial background might be highly correlated with other social char-
35 To identify those characteristics that are signiﬁcantly correlated with racial cate-
gories—but not to consider so many terms that signiﬁcant results are produced by
chance alone—we tested only attribute categories with at least 10 members (N p
and kept only those terms that are signiﬁcantly correlated with at least one racial
82)
category at P ! .01. Of these 23 terms, three had to be dropped from the model because
no intragroup ties were present and thus a ﬁnite coefﬁcient could not be estimated.
...
American Journal of Sociology
622
acteristics or with the shared focus that studying the same academic sub-
ject establishes.
...
fer some substantial interpretation of these ﬁndings. Why are levels of
...
Regarding the ﬁrst question, we speculate that those ethnic or racial cat-
...
closure vis-a`-vis whom they perceive as “minority” students.36
The discrimination/closure hypothesis could also explain why we ﬁnd
...
classiﬁed and treated as “black” by others or due to a marked tendency
...
for afﬁrmative action policies at the campus level. Finding themselves in
this peculiar social situation (being classiﬁed and treated as black by all
...
signiﬁcant degree of homophily among themselves as well. This inter-
...
Beyond and Below Racial Homophily
623
each other qua Africans and those speciﬁcally from Nigeria are not sig-
niﬁcantly more likely to develop a friendship than chance alone would
...
students, a shared political project—or at least a clearly deﬁned set of
...
British homophily obviously does not ﬁt this interpretation, but it also
...
classiﬁed and treated as “Asian” by others. In contrast, a strong pan-
...
sociodemographic structures inﬂuence degrees of homophily and therefore
...
ophily does not affect the racial homophily coefﬁcients for Hispanic stu-
dents, while it cuts the coefﬁcient for Asian homophily in half. Black and
...
Cuban, and Central American, which is roughly consistent with our ﬁndings (except
...
American Journal of Sociology
624
white homophily are only partly due to aggregation effects generated by
...
Whatever its causes, this “hyper-social” behavior ampliﬁes intragroup
...
dents, and this explains why the ampliﬁcation effects of balancing mech-
...
Beyond and Below Racial Homophily
625
differently for each racial category, direct interviews need to be conducted.
The aim of this article, however, is not so much to comprehend the spec-
iﬁcities of racial and ethnic homophilies among this particular group of
...
by pursuing an inductive strategy and attempting to ﬁnd a model that
best ﬁts the general characteristics of the observed network. Given a data
set with literally hundreds of attribute categories, how does one arrive
from the race/ethnicity models introduced above to a better-ﬁtting, more
...
simulation, and reﬁnement (see, e.g., Goodreau 2007). We developed a
transparent, replicable procedure for the speciﬁcation of our ﬁnal model.
Put simply, we ﬁrst ran separate models for each tie formation mechanism
...
highly signiﬁcant terms into a single model. We then pared this model
over multiple iterations to further eliminate unstable coefﬁcients.38
38 More precisely, we ﬁrst ran a large number of models that included only terms of a
...
ered any term that was statistically signiﬁcant at P ! .001 in any model to be a
...
were not merely a product of chance. All signiﬁcant homophily and sociality terms
were then combined into a single model. Again, only terms signiﬁcant at P ! .001 were
retained. These terms were then added to those structural terms that were found to
be signiﬁcant at
in the previous stage (namely, reciprocity, GWESP, GWDSP,
P ! .001
and GWOD) to form our ﬁrst “comprehensive” model. Because this model included
...
American Journal of Sociology
626
The Social World of College Students
What are the substantial ﬁndings of this inductive modeling strategy?
Table 2 shows that the process of tie formation at this college is inﬂuenced
...
racial homophily vis-a`-vis other tie-generating mechanisms that are an-
...
overall causal efﬁcacy of the various tie-generating mechanisms.
...
from Illinois (whatever their racial background) tend to befriendoneanother
...
coefﬁcient for students who attended an elite boarding school prior to college
...
50 iterations, using the ﬁnishing values of the previous cycle as a starting point for
the next, in order to obtain the ﬁnal parameter estimates for a model. We repeated
this process twice, each time discarding terms that were consistently insigniﬁcant across
multiple runs of a model, such that terms in the remaining model appeared to be the
most important determinants of tie formation. Model 6 (in table 2) is the ﬁnal product
...
Graduates of “select 16” boarding schools ........
1.04***
.19
Homophily based on shared cultural taste:a
Fans of Coldplay and Dave Matthews Band .....
.20***
.04
Fans of R&B, hip hop, and rap ...................
.32**
.11
...
American Journal of Sociology
628
slightly exceeds the coefﬁcient for black students and is over four times
greater than the coefﬁcient for white students.39
Equally important, we ﬁnd that racial homophily (and most of the other
...
than sharing the classiﬁcation of being white or Asian. Much less conse-
...
structurally imbalanced. The positive GWESP coefﬁcient and negative
GWOD coefﬁcient together indicate that there is a tendency toward clus-
...
social landscape that our students have generated and inhabit (ﬁg. 3). For
...
and education, ﬁnd a moderate level of homophily among students whose parents earn
...
and Sacerdote (2006, p. 20) ﬁnd that students at Dartmouth who attended elite prep
schools do not exchange e-mails more often with each other, but those who attended
New York’s specialized high schools do. Two students whose parents receive ﬁnancial
aid are not more likely to exchange e-mails. Together with our own ﬁndings, this
...
Beyond and Below Racial Homophily
629
Fig. 3.—A polymorphous landscape of homophily and foci effects
...
the values of the coefﬁcients from table 2). The relative size of a category
...
40 More precisely, for every pair of categories X and Y, we ﬁrst counted the total number
...
algorithm to produce the ﬁnal coordinates of each mountain in two-dimensional space.
...
630
Assessing Model Fit
Having discussed the ﬁnal model and offered a visual representation of
...
with the development of new ERG speciﬁcations and estimation procedures
has been the development of new means for evaluating model ﬁt (Hunter
et al. 2008). Rather than focusing exclusively on the signiﬁcance of particular
coefﬁcients, these methods seek to determine the extent to which the various
...
conﬁdence that the model’s mechanisms might indeed be similar to those
...
higher-order speciﬁcations appear to provide a good ﬁt to observed net-
work structures (Goodreau 2007; Hunter et al. 2008).
Figure 4 shows four “goodness-of-ﬁt” plots produced by 100 simulations
...
social ties, the plots in ﬁgure 4 compare the global structure of networks
...
Beyond and Below Racial Homophily
631
Fig. 4.—Goodness-of-ﬁt diagnostics. The thick line represents the observed network char-
...
ﬁt represented by AIC), P-values for each level of each of the four distributions are
...
American Journal of Sociology
632
Robustness Checks Using Alternative Methodologies
...
exercises as brieﬂy as possible here. First, we replicated all models using
...
niﬁcance levels are calculated by holding the network structure constant
...
change in signiﬁcance, but we observe the same types of reductions in
...
with only a few terms changing in signiﬁcance levels while the signs of
all coefﬁcients remain unchanged.42
Second, we replicated our results by again using ERG models but this
time determining signiﬁcance levels by leaving the empirical network
...
the picture friend network were randomly shufﬂed, and we compared the
...
inal ﬁndings, some caution should be used in interpretation. In particular,
...
work logistic regression coefﬁcients are incapable of handling models as large and complex
as ours. Furthermore, for the OLS regressions above, we rely on the “double semi-
partialing” permutation technique (Dekker et al. 2007) to calculate signiﬁcance levels for
...
Beyond and Below Racial Homophily
633
because network structure is kept intact but node “identities” are reas-
signed for signiﬁcance testing, model terms that are purely “structural”
...
signiﬁcance in the models above and other terms to have distorted sig-
niﬁcance levels. (This was not as problematic for the OLS replication
...
identiﬁed in this article, (2) estimating (via MCMC simulation) values for
higher-order structural terms that model the complex interdependencies
and feedback processes we expect to ﬁnd in social networks, and (3)
...
speciﬁc networking dispositions, and again indirectly through the process
...
classiﬁcation system itself, which should include several segmentally
...
American Journal of Sociology
634
egories on which network research usually relies. This more ﬁne-grained
...
network processes and of ethnoracial systems of classiﬁcation are com-
...
In a ﬁrst analytical step, we unpacked the racial homogeneity of this
...
ﬁcation effects of reciprocity and triadic closure. In contrast, neither the
...
both related and unrelated to racial categorizations, inﬂuence the for-
...
college students. This ﬁnding contrasts with the tendency of social net-
...
our ﬁndings with respect to other colleges in the United States, let alone
other populations or types of social networks. It is sufﬁcient to note here
...
Beyond and Below Racial Homophily
635
that three recent studies using the Add Health data set, which covers 130
...
networks (Kao and Joyner 2004). We are thus conﬁdent that many of the
...
signiﬁcance of race” or that American students at “elite” colleges represent
...
mechanisms that inﬂuence network composition as well as from ethnic
...
“race” that we ﬁnd in many lay and sociological accounts of group for-
mation in the United States?
We conclude by pointing toward three possible avenues for future re-
search. A ﬁrst possible route is to move away from the question of ethno-
...
American Journal of Sociology
636
example from ﬁgure 3, overprivilege relationships with South Asians?
...
social classiﬁcation best grasped through ethnographic research or sur-
...
want to have reﬂected in their way of categorizing the social world into
...
ﬁciently advanced modeling techniques to handle the task.
...
637
REFERENCES
Anthias, Floya. 1992. “Connecting ‘Race’ and Ethnic Phenomena.” Sociology 26:
421–38.
Antonio, Anthony Lising. 2001. “Diversity and the Inﬂuence of Friendship Groups in
College.” Review of Higher Education 25 (1): 63–89.
Baerveldt, Chris, Marijtje A. J. van Duijn, Lotte Vermeij, and Dianne A. Van Hemert.
2004. “Ethnic Boundaries and Personal Choice: Assessing the Inﬂuence of Individual
Inclinations to Choose Intra-ethnic Relationships on Pupil’s Networks.” Social Net-
works 26:55–77.
Bailey, Stefanie, and Peter V. Marsden. 1999. “Interpretation and Interview Context:
Examining the General Social Survey Name Generator Using Cognitive Methods.”
Social Networks 21:287–309.
Baltzell, E. Digby. 1958. Philadelphia Gentlemen: The Making of a National Upper
Class. New York: Free Press.
Banton, Michael P. 2003. “Teaching Ethnic and Racial Studies.” Ethnic and Racial
Studies 26 (3): 488–502.
Berry, Brent. 2006. “Friends for Better or for Worse: Interracial Friendship in the
United States as Seen through Wedding Party Photos.” Demography 43 (3): 491–510.
Blau, Peter. 1977. Inequality and Heterogeneity: A Primitive Theory of Social Struc-
ture. New York: Free Press.
Borgatti, Steve, Martin Everett, and Lin Freeman. 2002. Ucinet for Windows: Software
for Social Network Analysis. Harvard, Mass.: Analytic Technologies.
Boyd, Dana M., and Nicole B. Ellison. 2007. “Social Network Sites: Deﬁnition, History,
and Scholarship.” Journal of Computer-Mediated Communication 13 (1), art. 11.
http://www.jcmc.indiana.edu/13/issue1/boyd.ellison.
Brubaker, Rogers. 2004. Ethnicity without Groups. Cambridge, Mass.: Harvard Uni-
versity Press.
Bunge, Mario. 1997. “Mechanism and Explanation.” Philosophy of Social Sciences 27:
410–65.
Carley, Kathleen. 1991. “A Theory of Group Stability.” American Sociological Review
56 (3): 331–54.
Coleman, James S. 1990. Foundations of Social Theory. Cambridge, Mass.: Belknap.
Cookson, Peter W., Jr., and Caroline Hodges Persell. 1985. Preparing for Power: Amer-
ica’s Elite Boarding Schools. New York: Basic Books.
Cotterell, John. 1996. Social Networks and Social Inﬂuence in Adolescence. London:
Routledge.
...
MRQAP Tests to Collinearity and Autocorrelation Conditions.” Psychometrika 72:
563–81.
...
Epstein, Joyce L. 1985. “After the Bus Arrives: Resegregation in Desegregated Schools.”
Journal of Social Issues 41:23–43.
...
Espelage, Dorothy, Harold Green, and Stanley Wasserman. 2008. “Statistical Analysis
of Friendship Patterns and Bullying Behaviors among Youth.” Paper presented at
the International Sunbelt Social Networks Conference, St. Pete Beach, Florida,
January 22–27.
Espiritu, Yen Le. 1992. Asian American Panethnicity: Bridging Institutions and Iden-
tities. Philadelphia: Temple University Press.
Feld, Scott L. 1981. “The Focused Organization of Social Ties.” American Journal of
Sociology 86 (5): 1015–35.
Festinger, Leon, Stanley Schachter, and Kurt Back. 1963. Social Pressures in Informal
Groups: A Study of Human Factors in Housing. Stanford, Calif.: Stanford University
Press.
...
Social Networks 12:239–52.
Gap Min, Pyong, and Young Oak Kim. 2009. “Ethnic and Sub-ethnic Attachments
among Chinese, Korean, and Indian Immigrants in New York City.” Ethnic and
Racial Studies 32 (5): 758–80.
Geyer, Charles J., and Elizabeth A. Thompson. 1992. “Constrained Monte Carlo Max-
imum Likelihood for Dependent Data.” Journal of the Royal Statistical Society, ser.
B. 54 (3): 657–99.
Golder, Scott, A., Dennis Wilkinson, and Bernardo A. Huberman. 2007. “Rhythms of
Social Interaction: Messaging within a Massive Online Network.” Paper presented
at the third annual International Conference on Communities and Technologies,
London, May 21–25.
Goodreau, Steven M. 2007. “Advances in Exponential Random Graph (p*) Models
Applied to a Large Social Network.” Social Networks 29:231–48.
...
and National Origin. Oxford: Oxford University Press.
...
Online Social Networks. Paper presented at the ACM Workshop on Privacy in the
Electronic Society, Alexandria, Va., November 7.
Hallinan, Maureen T. 1978–79. “The Process of Friendship Formation.” Social Net-
works 1 (2): 193–210.
Hallinan, Maureen T., and Steven S. Smith. 1985. “The Effects of Classroom Racial
Composition on Students’ Interracial Friendliness.” Social Psychology Quarterly 48
(1): 3–16.
Hallinan, Maureen T., and Richard A. Williams. 1989. “Interracial Friendship Choices
in Secondary Schools.” American Sociological Review 54 (1): 67–78.
Handcock, Mark S. 2003a. “Assessing Degeneracy in Statistical Models of Social Net-
works.” Working paper no. 39. University of Washington, Center for Statistics and
the Social Sciences.
———. 2003b. “Statistical Models for Social Networks: Degeneracy and Inference.”
Pp. 229–40 in Dynamic Social Network Modeling and Analysis, edited by Ronald
...
Beyond and Below Racial Homophily
639
Breiger, Kathleen Carley, and Philippa Pattison. Washington, D.C.: National Acad-
emies Press.
Handcock, Mark S., David R. Hunter, Carter T. Butts, Steven M. Goodreau, and
Martina Morris. 2003. Statnet: Software Tools for the Statistical Modeling of Network
Data. http://www.statnetproject.org.
Hansell, Stephen, and Robert E. Slavin. 1981. “Cooperative Learning and the Structure
of Interracial Friendships.” Sociology of Education 54:98–106.
Hartmann, Douglas, Paul R. Croll, and Katja Guenther. 2003. “The Race Relations
‘Problematic’ in American Sociology: Revisiting Niemonen’s Case Study and Cri-
tique.” American Sociologist 34 (3): 20–55.
Hedstro¨m, Peter. 2005. Dissecting the Social: On the Principles of Analytical Sociology.
Cambridge: Cambridge University Press.
Heider, Fritz. 1946. “Attitudes and Cognitive Organization.” Journal of Psychology 21:
107–12.
...
Family Models for Metworks.” Journal of Computational and Graphical Statistics
15 (3): 565–83.
Jenkins, Richard. 1997. Rethinking Ethnicity: Arguments and Explorations. London:
Sage.
Joyner, Karam, and Grace Kao. 2000. “School Racial Composition and Adolescent
Racial Homophily.” Social Science Quarterly 81 (3): 810–25.
Kalmijn, Matthijs. 1998. “Intermarriage and Homogamy: Causes, Patterns and
Trends.” Annual Review of Sociology 24 (1): 395–421.
Kao, Grace, and Kara Joyner. 2004. “Do Race and Ethnicity Matter among Friends?
Activities among Interracial, Interethnic, and Intraethnic Adolescent Friends.”
Sociological Quarterly 45 (3): 557–73.
———. 2006. “Do Hispanic and Asian Adolescents Practice Panethnicity in Friendship
Choices?” Social Science Quarterly 87 (5): 972–92.
Keyes, Charles. 1976. “Towards a New Formulation of the Concept of Ethnic Group.”
Ethnicity 3 (3): 202–13.
Kibria, Nazli. 2002. Becoming Asian American: Second-Generation Chinese and
Korean American Identities. Baltimore: Johns Hopkins University Press.
Kornrich, Sabino. 2009. “Combining Preferences and Processes: An Integrated Ap-
proach to Black-White Labor Market Inequality.” American Journal of Sociology
115 (1): 1–38.
Kossinets, Gueorgi, and Duncan J. Watts. 2009. “Origins of Homophily in an Evolving
Social Network.” American Journal of Sociology 115 (2): 405–50.
Krysan, M. 1998. “Privacy and the Expression of White Racial Attitudes.” Public
Opinion Quarterly 62:506–44.
...
Speciﬁcation Problem in Network Analysis.” Pp. 18–34 in Applied Network Analysis:
A Methodological Introduction, edited by Ronald S. Burt and Michael J. Minor.
Beverly Hills, Calif.: Sage.
Lewis, Kevin, and Jason Kaufman. 2010. “An Ecological Approach to Cultural Tastes
and Social Network Evolution.” Manuscript. Harvard University, Department of
Sociology.
Lewis, Kevin, Jason Kaufman, and Nicholas Christakis. 2008. “The Taste for Privacy:
...
American Journal of Sociology
640
An Analysis of College Student Privacy Settings in an Online Social Network.”
Journal of Computer-Mediated Communication 14 (1): 79–100.
...
Lopez, David, and Yen Espiritu. 1990. “Panethnicity in the United States: A Theo-
retical. Framework.” Ethnic and Racial Studies 13:198–224.
Louch, Hugh. 2000. “Personal Network Integration: Transitivity and Homophily in
Strong-Tie Relations.” Social Networks 22:45–64.
Loveman, Mara. 1997. “Is ‘Race’ Essential?” American Sociological Review 64 (4):
891–98.
...
logical Review 52:122–31.
———. 1988. “Homogeneity in Conﬁding Relations.” Social Networks 10:57–76.
...
329–47.
McCranie, Ann, Stanley Wasserman, and Bernice Pescosolido. 2008. “Race, Gender,
and Status Stratiﬁcation in Work Networks: An ERG/p* Approach.” Paper presented
at the International Sunbelt Social Network Conference, St. Pete Beach, Florida,
January 22–27.
...
Sociological Review 52 (3): 370–79.
...
Moerman, Michael. 1965. “Ethnic Identiﬁcation in a Complex Civilization: Who Are
the Lue?” American Anthropologist 67 (5): 1215–30.
...
Friendship in Schools.” American Journal of Sociology 112 (2): 394–441.
Nagel, Joane. 2003. Race, Ethnicity, and Sexuality: Intimate Intersections, Forbidden
Frontiers. Oxford: Oxford University Press.
Niemonen, J. 1997. “The Race Relations Problematic in American Sociology: A Case
Study and Critique.” American Sociologist 28:15–54.
Oboler, Suzanne. 1997. “‘So Far from God, So Close to the United States’: The Roots
of Hispanic Homogenization.” Pp. 31–50 in Challenging Fronteras: Structuring La-
tina and Latino Lives in the U.S., edited by Mary Romero, Vilma Ortiz, and Pierrette
Hondagneu-Sotelo. New York: Routledge.
Okamoto, Dina G. 2006. “Institutional Panethnicity: Boundary Formation in Asian-
American Organizing.” Social Forces 85 (1): 1–25.
Okamura, Jonathan. 1981. “Situational Ethnicity.” Ethnic and Racial Studies 4 (4):
452–65.
Patchen, Martin. 1982. Black-White Contact in Schools. West Lafayette, Ind.: Purdue
University Press.
Patterson, Orlando. 1997. The Ordeal of Integration: Progress and Resentment in Amer-
ica’s ‘Racial’ Crisis. Washington, D.C.: Civitas/Counterpoint.
...
Beyond and Below Racial Homophily
641
Quillan, Lincoln, and Mary E. Campbell. 2003. “Beyond Black and White: The Present
and Future of Multiracial Friendship Segregation.” American Sociological Review
68 (4): 540–66.
Robins, Garry, and Philippa Pattison. 2005. “Interdependencies and Social Processes:
Generalized Dependence Structures.” Pp. 192–214 in Models and Methods in Social
Network Analysis, edited by Peter J. Carrington, John Scott, and Stanley Wasserman.
New York: Cambridge University Press.
Robins, Garry, Philippa Parrison, Yuval Kalish, and Dean Lusher. 2007a. “An Intro-
duction to Exponential Random Graph (p*) Models for Social Networks.” Social
Networks 29:173–91.
Robins, Garry, Pip Pattison, and Peng Wang. 2009. “Closure, Connectivity and Degree
Distributions: Exponential Random Graph (p*) Models for Directed Social Net-
works.” Social Networks 31:105–17.
Robins, Garry, Philippa Pattison, and Jodie Woolcock. 2004. “Missing Data in Net-
works: Exponential Random Graph (p*) Models for Networks with Non-respon-
dents.” Social Networks 26:257–83.
Robins, Garry, Tom Snijders, Peng Wang, Mark Handcock, and Philippa Pattison.
2007b. “Recent Developments in Exponential Random Graph (p*) Models for Social
nNetworks.” Social Networks 29:192–215.
Rogers, Everett M., and Dilip K. Bhowmik. 1970. “Homophily-Heterophily: Relational
Concepts for Communication Research.” Public Opinion Quarterly 34 (4): 523–38.
Rosenfeld, Michael J. 2001. “The Salience of Pan-national Hispanic and Asian Iden-
tities in U.S. Marriage Markets.” Demography 38:161–75.
Sacerdote, Bruce. 2001. “Peer Effects with Random Assignment: Results for Dartmouth
Roomates.” Quarterly Journal of Economics 116 (2): 681–704.
Saperstein, Aliya. 2006. “Double-Checking the Box: Examining Consistency between
Survey Measures of Observed and Self-Reported Race.” Social Forces 85 (1): 57–74.
Schoﬁeld, Janet W., and H. Andrew Sagar. 1977. “Peer Interaction Patterns in an
Integrated Middle School.” Sociometry 40 (2): 130–38.
Shrum, Wesley, Neil H. Cheek, Jr., and Saundra MacD. Hunter. 1988. “Friendship in
School: Gender and Racial Homophily.” Sociology of Education 61 (4): 227–39.
Simmel, Georg. 1908. Soziologie: Untersuchungen u¨ber die Formen der Vergesells-
chaftung [Sociology: Studies of the societal forms]. Berlin: Duncker & Humblot.
Smith, Tom W. 2002. “Measuring Inter-racial Friendships.” Social Science Research
31 (4): 576–93.
Snijders, Tom A. B. 2002. “Markov Chain Monte Carlo Estimation of Exponential
Random Graph Models.” Journal of Social Structure 3 (2). http://www.cmu.edu/joss/
index.html.
Snijders, Tom A. B., Philippa E. Pattison, Garry L. Robins, and Mark S. Handcock.
2006. “New Speciﬁcations for Exponential Random Graph Models.” Sociological
Methodology 36 (1): 99–153.
Sollors, Werner. 1991. The Invention of Ethnicity. Oxford: Oxford University Press.
Steglich, Christian E. G., Tom A. B. Snijders, and Michael Pearson. 2010. “Dynamic
Networks and Behavior: Separating Selection from Inﬂuence.” Sociological Meth-
odology. In press.
Steglich, Christian, Tom A. B. Snijders, and Patrick West. 2006. “Applying SIENA:
An Illustrative Analysis of the Coevolution of Adolescents’ Friendship Networks,
...
Networks.” Journal of the American Statistical Association 85:204–12.
Tilly, Charles. 1998. Durable Inequality. Berkeley and Los Angeles: University of
California Press.
———. 2006. Identities, Boundaries, and Social Ties. Boulder, Colo.: Paradigm.
...
American Journal of Sociology
642
Torres, Kimberly. 2009. “‘Culture Shock’: Black Students Account for Their Distinc-
tiveness at an Elite College.” Ethnic and Racial Studies 32 (5): 883–905.
Van Laar, Colette, Shana Levin, Stacey Sinclair, and Jim Sidanius. 2005. “The Effect
of University Roommate Contact on Ethnic Attitudes and Behavior.” Journal of
Experimental Social Psychology 41:329–45.
...
Minority Classmates.” Social Networks 41 (4): 230–39.
Wallman, Sandra. 1986. “Ethnicity and the Boundary Making Process in Context.”
Theories of Race and Ethnic Relations, edited by John Rex. Cambridge: Cambridge
University Press.
Wasserman, Stanley, and Garry Robins. 2005. “An Introduction to Random Graphs,
Dependence Graphs, and p*.” Pp. 148–61 , in Models and Methods in Social Network
Analysis, edited by Peter J. Carrington, John Scott, and Stanley Wasserman. New
York: Cambridge University Press..
Waters, Mary C. 1990. Ethnic Options: Choosing Identities in America. Berkeley and
Los Angeles: University of California Press.
———. 1999. Black Identities: West Indian Immigrant Dreams and American Real-
ities. Cambridge, Mass.: Harvard University Press.
Way, Niobe, and Lisa Chen. 2000. “Close and General Friendships among African
American, Latino, and Asian American Adolescents from Low-Income Families.”
Journal of Adolescent Research 15 (2): 274–301.
Wellman, Barry, Janet Salaff, Dimitrina Dimitrova, Laura Garton, Milena Gulia, and
Caroline Haythornthwaite. 1996. “Computer Networks as Social Networks: Collab-
orative Work, Telework, and Virtual Community.” Annual Review of Sociology 22:
213–38.
Wimmer, Andreas. 2008. “The Making and Unmaking of Ethnic Boundaries: A Multi-
level Process Theory.” American Journal of Sociology 113 (4): 970–1022.
